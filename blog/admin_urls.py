...
from blog.admin_views import PostView, DeletePost, NewPost, UpdatePostIndexView, AddPost, \
	...
	CatalogueView,NewCatalogueView,AddCatalogue
...
urlpatterns = [
    url(r'^admin/', include([
		...
		url(r'^catalogue$', CatalogueView.as_view()),
		url(r'^new/catalogue$', NewCatalogueView.as_view()),
		url(r'^add/catalogue$', AddCatalogue.as_view()),
    ])),
]